            ...
            var r = e('../lib/oop'),
                ...
                s = function (e) {
                    ...
                    (this.$rules = {
                        ...
                        attributes: [
                            { token: 'entity.other.attribute-name.xml', regex: '(?:' + t + ':)?' + t + '' },
                            { token: 'keyword.operator.attribute-equals.xml', regex: '=' },
                            ...
                            },
                            {
                                token: function (e) {
                                    return n.hasOwnProperty(e)
                                        ...
                                        : e == 'debugger'
                                        ? 'invalid.deprecated'
                                        : e.match(/^(\$[a-zA-Z_\x7f-\uffff][a-zA-Z0-9_\x7f-\uffff]*|self|parent)$/)
                                        ? 'variable'
                                        : 'identifier';
                                },
    ...
    define('ace/mode/php_completions', ['require', 'exports', 'module'], function (e, t, n) {
        ...
        (function () {
            (this.getCompletions = function (e, t, n, r) {
                ...
                return i.type === 'string' && /(\$[\w]*)\[["']([^'"]*)$/i.test(o)
            ...
            (this.completionsDefined = !1),
                ...
                (this.getCompletions = function (e, t, n, r) {
                    ...
                    if (e === 'ruleset') {
                        var s = t.getLine(n.row).substr(0, n.column);
                        return /:[^;]+$/.test(s)
                            ? (/([\w\-]+):[^:]*$/.test(s), this.getPropertyValueCompletions(e, t, n, r))
                    ...
                    return r
                        ? r.closing || (!r.tagName && r.selfClosing)
                            ? t == 'markbeginend'
                                ? 'end'
                                : ''
                            : !r.tagName || r.selfClosing || this.voidElements.hasOwnProperty(r.tagName.toLowerCase())
                            ? ''
            ...
            r.inherits(g, i),
                function () {
                    (this.tokenRe = new RegExp(
                        '^[' + p.packages.L + p.packages.Mn + p.packages.Mc + p.packages.Nd + p.packages.Pc + '_]+',
                        'g'
                    )),
