                ...
                (this.enter = function (e, t) {
                    ...
                    (this.highlight = function (e, t) {
                        var n = (e.$occurHighlight =
                            e.$occurHighlight || e.addDynamicMarker(new u(null, 'ace_occur-highlight', 'text')));
        ...
        function (e, t, n) {
            ...
            (t.iSearchStartCommands = [
                ...
                (t.iSearchCommands = [
                    ...
                    return (
                        (e.readOnly = !0), (e.isIncrementalSearchCommand = !0), (e.scrollIntoView = 'animate-cursor'), e
                    );
                })),
                i.inherits(u, s),
                function () {
                ...
                function () {
                    (this.activate = function (e, t) {
                        (this.$editor = e),
                            ...
                            (this.$mousedownHandler = e.addEventListener('mousedown', this.onMouseDown.bind(this))),
                            this.selectionFix(e),
                        ...
                        (this.cancelSearch = function (e) {
                            ...
                            return (
                                ...
                                (this.$options.needle = ''),
                                e
                                    ? (t.moveCursorToPosition(this.$startPos), (this.$currentPos = this.$startPos))
                        ...
                        (this.highlightAndFindWithNeedle = function (e, t) {
                            ...
                            return (
                                s &&
                                    ...
                                    this.$editor.selection.setRange(i.fromPoints(o ? this.$startPos : s.end, s.end)),
            ...
            (t.handler.attach = function (e) {
                ...
                (t.handler.detach = function (e) {
                    delete e.renderer.screenToTextCoordinates,
                        ...
                        (e.session.$useEmacsStyleLineStart = f),
                        e.removeEventListener('click', c),
                        e.removeEventListener('changeSession', l),
                        e.unsetStyle('emacs-mode'),
                        e.commands.removeCommands(v),
                        e.removeEventListener('copy', this.onCopy),
                        e.removeEventListener('paste', this.onPaste),
                        (e.$emacsModeHandler = null);
                });
            var l = function (e) {
                    e.oldSession && ((e.oldSession.$selectLongWords = a), (e.oldSession.$useEmacsStyleLineStart = f)),
                        (a = e.session.$selectLongWords),
                        (e.session.$selectLongWords = !0),
                        (f = e.session.$useEmacsStyleLineStart),
                        (e.session.$useEmacsStyleLineStart = !0),
                        e.session.hasOwnProperty('$emacsMark') || (e.session.$emacsMark = null),
                        e.session.hasOwnProperty('$emacsMarkRing') || (e.session.$emacsMarkRing = []);
                },
                c = function (e) {
            ...
            d.forEach(function (e) {
                ...
                (t.handler.handleKeyboard = function (e, t, n, r) {
                    ...
                    if (o == 'c-' || e.count) {
                        ...
                        if (typeof u == 'number' && !isNaN(u))
                            return (
                                (e.count = Math.max(e.count, 0) || 0), (e.count = 10 * e.count + u), { command: 'null' }
                            );
                    }
                    ...
                    if (typeof a == 'string') {
                        (a === 'insertstring' || a === 'splitline' || a === 'togglecomment') && i.pushEmacsMark(),
                ...
                t.handler.addCommands({
                    ...
                    killWord: {
                        exec: function (e, n) {
                            e.clearSelection(),
                                n == 'left' ? e.selection.selectWordLeft() : e.selection.selectWordRight();
