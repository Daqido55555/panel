...
(function (e) {
        ...
        (function () {
            ...
            (function () {
                ...
                function MediaQuery(e, t, n, r, i) {
                    SyntaxUnit.call(
                        this,
                        (e ? e + ' ' : '') + (t ? t : '') + (t && n.length > 0 ? ' and ' : '') + n.join(' and '),
                        r,
                        i,
                ...
                function PropertyValuePart(text, line, col) {
                    ...
                    if (/^([+\-]?[\d\.]+)([a-z]+)$/i.test(text)) {
                        ...
                        /^([+\-]?[\d\.]+)%$/i.test(text)
                            ...
                            : /^([^\(]+)\(/i.test(text)
                            ? ((this.type = 'function'), (this.name = RegExp.$1), (this.value = text))
                            : /^["'][^"']*["']/.test(text)
                            ...
                            n = {
                                ...
                                _namespace: function (e) {
                                    ...
                                    t.mustMatch(Tokens.NAMESPACE_SYM),
                                        ...
                                        this._readWhitespace(),
                                        e !== !1 &&
                                            this.fire({ type: 'namespace', prefix: i, uri: s, line: n, col: r });
                                },
                                _media: function () {
                                    var e = this._tokenStream,
                                        t,
                    ...
                    azimuth: function (e) {
                        ...
                        if (e.hasNext())
                            throw (
                                ((s = e.next()),
                                i
                                    ? new ValidationError("Expected end of value but found '" + s + "'.", s.line, s.col)
                                    : new ValidationError(
                    ...
                    'border-image-slice': function (e) {
                        ...
                        if (e.hasNext())
                            throw (
                                ((o = e.next()),
                                t
                                    ? new ValidationError("Expected end of value but found '" + o + "'.", o.line, o.col)
                                    : new ValidationError(
                ...
                TokenStream.prototype = mix(new TokenStreamBase(), {
                    ...
                    htmlCommentStartToken: function (e, t, n) {
                        ...
                        return (
                            r.mark(),
                            (i += r.readCount(3)),
                            i == '<!--' ? this.createToken(Tokens.CDO, i, t, n) : (r.reset(), this.charToken(e, t, n))
                        );
                    },
                    htmlCommentEndToken: function (e, t, n) {
                        ...
                        return (
                            r.mark(),
                            (i += r.readCount(2)),
                            i == '-->' ? this.createToken(Tokens.CDC, i, t, n) : (r.reset(), this.charToken(e, t, n))
                        );
                    },
                    ...
                    readEscape: function (e) {
                        ...
                        return (
                            (n.length == 3 && /\s/.test(i)) || n.length == 7 || n.length == 1 ? t.read() : (i = ''),
                            n + i
                        );
                    },
                ...
                var ValidationTypes = {
                    ...
                    simple: {
                        ...
                        '<margin-width>': function (e) {
                            return (
                                this['<length>'](e) || this['<percentage>'](e) || ValidationTypes.isLiteral(e, 'auto')
                            );
                        },
                    ...
                    complex: {
                        ...
                        '<shadow>': function (e) {
                            ...
                            if (e.hasNext()) {
                                ...
                                e.hasNext() &&
                                    (i || ValidationTypes.isAny(e, '<color>'), r || ValidationTypes.isAny(e, 'inset')),
                                    (t = n >= 2 && n <= 4);
                            }
                            return t;
                        },
        ...
        (Reporter.prototype = {
                ...
                init: function (e, t) {
                    ...
                    e.addListener('property', function (e) {
                        ...
                        e.addListener('endstylesheet', function () {
                            t.stat('font-sizes', r),
                                r >= 10 &&
                                    t.rollupWarn('Too many font-size declarations (' + r + '), abstraction needed.', n);
                        });
                },
            }),
            CSSLint.addRule({
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    function i(e) {
                        e.selectors
                            ? (r = { line: e.line, col: e.col, selectors: e.selectors, propCount: 0, outline: !1 })
                            : (r = null);
                    }
                    function s() {
                        r &&
    ...
    define(
        'ace/mode/css_worker',
        ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/worker/mirror', 'ace/mode/css/csslint'],
        function (e, t, n) {
            'use strict';
            var r = e('../lib/oop'),
                i = e('../lib/lang'),
