...
export default () => {
    ...
    return (
        <TitledGreyBox title={'Reinstall Server'} css={tw`relative`}>
            ...
            <p css={tw`text-sm`}>
                Reinstalling your server will stop it, and then re-run the installation script that
                initially set it up.&nbsp;
                <strong css={tw`font-medium`}>
                    Some files may be deleted or modified during this process, please back up your
