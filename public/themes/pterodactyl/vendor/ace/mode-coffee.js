    ...
    function (e, t, n) {
        ...
        function s() {
            var e = '[$A-Za-z_\\x7f-\\uffff][$\\w\\x7f-\\uffff]*',
                t =
                    'this|throw|then|try|typeof|super|switch|return|break|by|continue|catch|class|in|instanceof|is|isnt|if|else|extends|for|own|finally|function|while|when|new|no|not|delete|debugger|do|loop|of|off|or|on|unless|until|and|yes',
                n = 'true|false|null|undefined|NaN|Infinity',
                r =
                    'case|const|default|function|var|void|with|enum|export|implements|interface|let|package|private|protected|public|static|yield',
                i =
