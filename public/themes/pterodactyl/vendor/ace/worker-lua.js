        ...
        (function (e, n, r) {
            ...
            function X() {
                ...
                if (n.comments) {
                    ...
                    n.locations && (f.loc = { start: { line: a, column: M - u }, end: { line: _, column: C - D } }),
            ...
            function Mt() {
                ...
                return (
                    J('else') && (mt && ((r = new yt(L)), vt.push(r)), (n = St()), e.push(m(v.elseClause(n)))),
                    K('end'),
                    m(v.ifStatement(e))
                );
            }
            ...
            (yt.prototype.complete = function () {
                n.locations && ((this.loc.end.line = L.line), (this.loc.end.column = L.range[1] - L.lineStart)),
