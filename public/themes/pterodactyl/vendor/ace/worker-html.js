                    ...
                    function (e, t, n) {
                        function r(e) {
                            ...
                            if (e.namespaceURI === 'http://www.w3.org/2000/svg')
                                return (
                                    e.localName === 'foreignObject' || e.localName === 'desc' || e.localName === 'title'
                                );
                        }
                        function i(e) {
                            return (
                        ...
                        function a(e) {
                            return (
                                r(e) || (e.namespaceURI === 'http://www.w3.org/1999/xhtml' && e.localName === 'button')
                            );
                        }
                        function f(e) {
                            return (
                                ...
                                function m(e) {
                                    ...
                                    return (
                                        s(i) && r
                                            ...
                                            : (t._emitToken({ type: 'Characters', data: '</' + this._temporaryBuffer }),
                                              e.unget(i),
                                              t.setState(f)),
                                        !0
                                    );
                                ...
                                function I(e) {
                                    ...
                                    return (
                                        i === r.EOF
                                            ...
                                            ? t.setState(K)
                                            : i === '\0'
                                            ? (t._parseError('invalid-codepoint'), (t._currentToken.name += '\ufffd'))
                                ...
                                function U(e) {
                                    ...
                                    if (i === r.EOF)
                                        ...
                                        i === '='
                                            ...
                                            ? t._emitCurrentToken()
                                            : o(i)
                                            ? (t._currentToken.data.push({ nodeName: i, nodeValue: '' }), t.setState(R))
                                            : i === '/'
                                            ? t.setState(K)
                                            : i === "'" || i === '"' || i === '<'
                                ...
                                function ut(e) {
                                    ...
                                    return (
                                        i === r.EOF
                                            ...
                                            : i === '>'
                                            ? (t.setState(n), t._emitCurrentToken())
                                            : (o(i) && (i = i.toLowerCase()), (t._currentToken.name += i), e.commit()),
                                        !0
                                    );
                                }
                                function at(e) {
                                ...
                                function ft(e) {
                                    ...
                                    return (
                                        i === r.EOF
                                            ...
                                            ? t.setState(lt)
                                            : i === "'" || i === '"'
                                            ? (t._parseError('unexpected-char-in-doctype'), e.unget(i), t.setState(lt))
                                ...
                                function vt(e) {
                                    ...
                                    return (
                                        i === r.EOF
                                            ...
                                            ? t.setState(mt)
                                            : i === "'" || i === '"'
                                            ? (t._parseError('unexpected-char-in-doctype'), e.unget(i), t.setState(mt))
